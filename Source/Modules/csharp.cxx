...
public:
  ...
  void emitProxyClassDefAndCPPCasts(Node *n) {
	...
	if (mono_aot_compatibility_flag) {
	  Printf(proxy_class_code, "      swigDelegate%sdispatcher = new SwigDelegate%s_%s_Dispatcher(SwigDirectorMethod%s_Dispatcher);\n", methid, proxy_class_name, methid, overname);
  ...
  int classDirectorMethod(Node *n, Node *parent, String *super) {
	...
	Printf(callback_mono_aot_def, "  private static %s SwigDirectorMethod%s_Dispatcher(", tm, overloaded_name);
      }
